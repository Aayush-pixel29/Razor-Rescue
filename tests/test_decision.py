...
def test_hard_stop_risky_card_overrides_confidence():
    ...
    record = PaymentRecord(payment_id="123", amount=100, currency="INR", status="failed", retry_count=0, created_at=1234567890)
...
def test_hard_stop_max_retries_overrides_confidence():
    ...
    record = PaymentRecord(payment_id="123", amount=100, currency="INR", status="failed", retry_count=4, created_at=1234567890)
